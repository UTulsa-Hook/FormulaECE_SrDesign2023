 ...
 * File: _coder_AutoCodeTopLevel_mex.c
 *
                 ...
                 const mxArray *prhs[])
{
  static const char_T *emlrtEntryPoints[8] = {
      "AutoCodeCheckHalfPlane", "AutoCodeControl",     "AutoCodeControlCircle",
      "AutoCodeControlLine",    "AutoCodeEstimatePos", "AutoCodeInitialize",
  ...
  mexAtExit(&AutoCodeTopLevel_atexit);
  /* Module initialization. */
  AutoCodeTopLevel_initialize();
  st.tls = emlrtRootTLSGlobal;
  /* Dispatch the entry-point. */
  switch (emlrtGetEntryPointIndexR2016a(
      &st, nrhs, &prhs[0], (const char_T **)&emlrtEntryPoints[0], 8)) {
  case 0:
    unsafe_AutoCodeCheckHalfPlane_mexFunction(nlhs, plhs, nrhs - 1, &prhs[1]);
    break;
  case 1:
    unsafe_AutoCodeControl_mexFunction(nlhs, plhs, nrhs - 1, &prhs[1]);
    break;
  case 2:
    unsafe_AutoCodeControlCircle_mexFunction(nlhs, plhs, nrhs - 1, &prhs[1]);
    break;
  case 3:
    unsafe_AutoCodeControlLine_mexFunction(nlhs, plhs, nrhs - 1, &prhs[1]);
    break;
  case 4:
                                               ...
                                               const mxArray *prhs[1])
{
  ...
  if (nrhs != 1) {
    emlrtErrMsgIdAndTxt(&st, "EMLRT:runTime:WrongNumberOfInputs", 5, 12, 1, 4,
                        22, "AutoCodeCheckHalfPlane");
  }
  if (nlhs > 1) {
    emlrtErrMsgIdAndTxt(&st, "EMLRT:runTime:TooManyOutputArguments", 3, 4, 22,
                        "AutoCodeCheckHalfPlane");
  }
  /* Call the function. */
  AutoCodeCheckHalfPlane_api(prhs[0], &outputs);
                                              ...
                                              const mxArray *prhs[2])
{
  ...
  if (nrhs != 2) {
    emlrtErrMsgIdAndTxt(&st, "EMLRT:runTime:WrongNumberOfInputs", 5, 12, 2, 4,
                        21, "AutoCodeControlCircle");
  }
  if (nlhs > 1) {
    emlrtErrMsgIdAndTxt(&st, "EMLRT:runTime:TooManyOutputArguments", 3, 4, 21,
                        "AutoCodeControlCircle");
  }
  /* Call the function. */
  AutoCodeControlCircle_api(prhs, &outputs);
  /* Copy over outputs to the caller. */
  emlrtReturnArrays(1, &plhs[0], &outputs);
}
                                            ...
                                            const mxArray *prhs[1])
{
  ...
  /* Call the function. */
  AutoCodeControlLine_api(prhs[0], &outputs);
  /* Copy over outputs to the caller. */
  emlrtReturnArrays(1, &plhs[0], &outputs);
}
...
/*
 * File trailer for _coder_AutoCodeTopLevel_mex.c
 *
 * [EOF]
 */
