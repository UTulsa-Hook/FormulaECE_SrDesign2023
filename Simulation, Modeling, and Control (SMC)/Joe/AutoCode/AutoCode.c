...
int controlArray[2][9]={{1,10,10,10,4.5,-1,0,0,0},//line
                          {0,0,0,0,0,0,0,0,0}};

/*int controlArray[2][9] = {{0,10,10,1.5,0,-1,0,0,0},//circ
                       {0,0,0,0,0,0,0,0,0}};*/
/*int controlArray[4][9] = {{0,10,10,1.5,0,n1,n2,n3,n4},
                            {1,8.5,10,8.5,7.5,n1,n2,n3,n4},
                            {0,10,7.5,1.5,0,n1,n2,n3,n4},
                            {1,11.5,7.5,11.5,10,n1,n2,n3,n4}}; //test track*/
/*int controlArray[4][9] = {{1, 1, 9, 1, 2, 0, -1, 1, 2}, 
                          {0, 2.1, 2.1, 1, 1, 1, 0, 2, 1 */                      
int controlIndex;
