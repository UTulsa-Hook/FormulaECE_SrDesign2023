...
int readInPipe(struct Pipes file, char *buff, int buffsize)
{
    return read(file.in, buff, buffsize);
}

void writeOutPipe(struct Pipes file, char *outbuff, int buffsize)
{
    write(file.out, outbuff, buffsize);
}
